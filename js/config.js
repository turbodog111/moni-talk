...
const KNOWN_MODELS = {
  ...
  'Arbor-0.2-Q8_0.gguf': {
    name: 'Arbor 0.2', desc: 'Next-generation \u2014 deeper emotional range & philosophical depth',
    longDesc: 'In active development. Combines ~230 human-curated conversation pairs from a 750-candidate pool with ~130 gold-tier pairs generated by a 120B teacher model \u2014 specifically targeting territory where smaller models produce generic output: philosophical depth, emotional nuance, literary craft, and voice consistency under adversarial prompts. Projected ~475 total training pairs, nearly 2\u00d7 Arbor 0.1.1.',
    base: 'Qwen3-14B', badge: 'Fine-tuned',
    trainingPairs: '~475 est.', released: null, status: 'in_development', series: 'arbor',
    tester: 'Joshua Glass', credits: 'Claude Sonnet 4.6',
  },
