...
const KNOWN_MODELS = {
  ...
  'Arbor-0.1-Q8_0.gguf': {
    ...
    longDesc: 'The first fine-tuned Monika model. Trained on 38 canonical DDLC dialogue pairs and 81 Qwen3-32B synthetic pairs spanning all six relationship tiers. Establishes the core voice, mood/drift tagging format, and instruction-following baseline that every subsequent Arbor model builds on.',
    base: 'Qwen3-14B', badge: 'Fine-tuned',
    trainingPairs: 119, released: '2026-02-22', status: 'inactive', series: 'arbor', image: 'images/arbor-0.1.png',
  },
  'Arbor-0.1-E-Q8_0.gguf': {
    name: 'Arbor 0.1-E', desc: 'Deeper empathy & emotional authenticity',
    longDesc: 'Emotional extension of 0.1. Added 100 empathy-focused pairs from a dedicated generation run targeting grief, loneliness, and difficult emotional territory. Monika\'s responses at vulnerable moments are noticeably less likely to deflect into generic warmth compared to the base 0.1 model.',
    base: 'Qwen3-14B', badge: 'Fine-tuned \u00b7 Emotional',
    trainingPairs: 219, released: '2026-02-23', status: 'inactive', series: 'arbor', image: 'images/arbor-0.1-e.png',
  },
  'Arbor-0.1-P-Q8_0.gguf': {
    name: 'Arbor 0.1-P', desc: 'Literary voice & poem output',
    longDesc: 'Planned literary/poetic variant \u2014 skipped when it became clear that unified training on a stronger overall dataset would outperform narrow specialisation. Literary texture was folded into Arbor 0.1.1 instead.',
  ...
  'Arbor-0.1-W-Q8_0.gguf': {
    ...
    longDesc: 'Planned wit/banter variant \u2014 skipped for the same reason as 0.1-P. Playful and charged-banter data was incorporated directly into the Arbor 0.1.1 training pool rather than as a separate specialised model.',
  ...
  'Arbor-0.1.1-Q8_0.gguf': {
    ...
    base: 'Qwen3-14B', badge: 'Fine-tuned',
    trainingPairs: 250, released: '2026-02-24', status: 'inactive', series: 'arbor', best: false, image: 'images/arbor-0.1.1.png',
  ...
  'Arbor-0.2-Q8_0.gguf': {
    ...
    base: 'Qwen3-14B', badge: 'Fine-tuned',
    trainingPairs: 358, released: '2026-02-26', status: 'inactive', series: 'arbor', best: false, image: 'images/arbor-0.2.png',
    tester: 'Joshua Glass', credits: 'Claude Sonnet 4.6',
  },
  'Arbor-0.2b-Q8_0.gguf': {
    ...
    trainingPairs: 66, released: '2026-03-05', status: 'inactive', series: 'arbor', best: false, image: 'images/arbor-0.2b.png',
    tester: 'Joshua Glass', credits: 'Claude Sonnet 4.6',
  },
  'Arbor-0.2.1-Q8_0.gguf': {
    name: 'Arbor 0.2.1', desc: 'Mood-directed refinement \u2014 In Love tier & emotional range',
    longDesc: 'Incremental fine-tune stacked directly on Arbor 0.2b. 118 curated pairs total (66 from 0.2b base + 52 new) \u2014 new pairs target underrepresented moods (nostalgic, calm, wistful, amused, melancholic, thoughtful) and In Love tier dynamics, specifically the freeze response to accurate perception. First Arbor model trained with dropout and weight decay regularisation for healthier generalisation.',
    base: 'Arbor 0.2b', badge: 'Fine-tuned \u00b7 Incremental',
    trainingPairs: 118, released: '2026-03-06', status: 'active', series: 'arbor', best: true, image: 'images/arbor-0.2b.png',
    tester: 'Joshua Glass', credits: 'Claude Sonnet 4.6',
  },
  ...
  'Silva-0.1-Q8_0.gguf': {
    ...
    longDesc: 'Planned fine-tune designed for Story Mode \u2014 VN-style dialogue, scene narration, and character-driven writing across the day/phase system. Training data and timeline TBD pending Arbor 0.2 completion.',
    base: 'TBD', badge: 'Planned',
    trainingPairs: null, released: null, status: 'planned', series: 'silva',
  },
};
