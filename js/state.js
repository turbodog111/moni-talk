...
let _lastPromptTokens = 0;        // prompt_tokens from last API response
let _lastCompletionTokens = 0;    // completion_tokens from last API response
let _contextWindowSize = 0;       // n_ctx fetched from /props (llamacpp) or known limit
